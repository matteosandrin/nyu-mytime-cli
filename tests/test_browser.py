...
def test_printing_punch_out_status(driver):
	...
	driver.get("file://"+os.path.dirname(os.path.abspath(__file__))+"/html/test_status_page.html")
...
def test_iframe_switching(driver):
	driver.get("file://"+os.path.dirname(os.path.abspath(__file__))+"/html/test_iframe_page.html")
